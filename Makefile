...
LDFLAGS = -lgcov -fprofile-arcs -ftest-coverage -lcurl
LDFLAGS_RELEASE = -lcurl
...
release:
	@make -C main VERSION=$(VERSION) BUILD_OUTPUT_DIR=$(BUILD_OUTPUT_DIR_RELEASE) CXXFLAGS='$(CXXFLAGS_RELEASE)' TARGET=$(TARGET) LDFLAGS='$(LDFLAGS_RELEASE)'
